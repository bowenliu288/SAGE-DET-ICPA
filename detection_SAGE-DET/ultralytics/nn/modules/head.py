...
__all__ = "OBB", "Classify", "Detect", "LPGDH", "Pose", "RTDETRDecoder", "Segment", "YOLOEDetect", "YOLOESegment", "v10Detect"
...
class LPGDH(Detect):
    """Lightweight Progressive-Guided Detection Head (LPGDH) for small UAV detection.
    ...
    residual box refinement branch. The design is intended to complement DCDM and
    P5SGM: the former preserves small-target details, the latter injects high-level
    ...
    def __init__(self, nc: int = 80, reg_max=1, end2end=False, ch: tuple = ()):  # noqa: D417
        """Initialize the Lightweight Progressive-Guided Detection Head (LPGDH).
    ...
    def fuse(self) -> None:
        ...
        The auxiliary prior, quality, and refinement branches must be preserved because the one2one
        prediction path still uses them during final validation and inference.
        """
        self.cv2 = self.cv3 = None
