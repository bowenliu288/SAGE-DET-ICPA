...
from ultralytics.nn.modules.block import P5SGM
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m is DCDM:
            ...
            assert isinstance(f, list) and len(f) == 2, "P5SGM (P5-SGM) requires two inputs: [P2, P5]"
            c2 = ch[f[0]]
            args = [ch[f[0]], ch[f[1]]]
            ...
            if m in {Detect, LPGDH, YOLOEDetect, Segment, Segment26, YOLOESegment, YOLOESegment26, Pose, Pose26, OBB, OBB26}:
                m.legacy = legacy
        elif m is v10Detect:
