...
from ultralytics.nn.modules.block import P5SemanticGate
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {CBDDownLite, CBDDownLiteNoGate}:
            c1 = ch[f]
        ...
        elif m is P5SemanticGate:
            assert isinstance(f, list) and len(f) == 2, "P5SemanticGate requires two inputs: [P2, P5]"
            c2 = ch[f[0]]
            args = [ch[f[0]], ch[f[1]]]
            ...
            if m in {Detect, PGLiteDetect, Detect_LSCSBD, YOLOEDetect, Segment, Segment26, YOLOESegment, YOLOESegment26, Pose, Pose26, OBB, OBB26}:
                m.legacy = legacy
        elif m is v10Detect:
